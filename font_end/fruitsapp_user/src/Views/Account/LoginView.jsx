                    ...
                    <div className="overflow-hidden bg-white rounded-md shadow-md">
                        <div className="px-4 py-6 sm:px-8 sm:py-7">
                            <div className="text-center">
                                ...
                                <p className="mt-2 text-base text-gray-600">Don’t have one? <Link to="#" title="" className="text-blue-600 transition-all duration-200 hover:underline hover:text-blue-700">Create a free account</Link></p>
                            </div>
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div>
                                        <div className="flex items-center justify-between">
                                            ...
                                            <Link to="#" title="" className="text-sm font-medium transition-all duration-200 text-rose-500 hover:text-rose-600 focus:text-rose-600 hover:underline"> Forgot password? </Link>
                                        </div>
                                        <div className="mt-2.5">
